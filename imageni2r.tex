...
\begin{table*}[!b]
    ...
    \begin{tabular}{ll|cccccccccc}
        ...
        & ImagenI2R & \cellcolor{blue!10}\textbf{1.28} & \cellcolor{blue!10}\textbf{2.76} & \cellcolor{blue!10}\textbf{0.96} & \cellcolor{blue!10}\textbf{1.43} & \cellcolor{blue!10}\textbf{3.66} & \cellcolor{blue!10}\textbf{2.44} & \cellcolor{blue!10}\textbf{1.00} & \cellcolor{blue!10}\textbf{0.48} & \cellcolor{blue!10}\textbf{0.21} &
        ...
        & ImagenI2R & \cellcolor{blue!10}\textbf{1.52} & \cellcolor{blue!10}\textbf{1.90} & \cellcolor{blue!10}\textbf{1.24} & \cellcolor{blue!10}\textbf{1.85} & \cellcolor{blue!10}\textbf{1.87} & - & \cellcolor{blue!10}\textbf{1.72} & \cellcolor{blue!10}\textbf{1.46} & \cellcolor{blue!10}\textbf{0.76} & - \\
        \midrule

        %------------------------------------
        % Training Time
        \multirow{2}{*}{\rotatebox{90}{\textbf{768}}} & KoVAE & 31.53 & 37.66 & 67.97 & 72.58 & 52.93 & - & 21.04 & 14.64 & 16.27 & - \\
        & ImagenI2R & \cellcolor{blue!10}\textbf{5.38} & \cellcolor{blue!10}\textbf{2.61} & \cellcolor{blue!10}\textbf{12.20} & \cellcolor{blue!10}\textbf{7.49} & \cellcolor{blue!10}\textbf{9.47} & - & \cellcolor{blue!10}\textbf{4.96} & \cellcolor{blue!10}\textbf{8.24} & \cellcolor{blue!10}\textbf{2.74} & -\\
        \bottomrule
    \end{tabular}
    }
\end{table*}
...
\begin{table*}[!t]
    \centering
    \caption{Averaged results over 30\%, 50\%, 70\% missing rates for sequence lengths 24, 96, and 768. Lower values are better. Dashes for TimeGAN-$\Delta t$ and GT-GAN at lengths 96 and 768 indicate these baselines were not run at longer sequences; Electricity is not evaluated at lengths 96 and 768.}
    ...
    \begin{tabular}{lll|ccccccccc}
        ...
        %==================================================
        \multirow{20}{*}{\rotatebox{90}{\textbf{Length $= 24$}}}
        & \multirow{5}{*}{\rotatebox{90}{\textbf{Disc.}}}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.037} & \cellcolor{blue!10}\textbf{0.009} & \cellcolor{blue!10}\textbf{0.012} & \cellcolor{blue!10}\textbf{0.011} & \cellcolor{blue!10}\textbf{0.057} & \cellcolor{blue!10}\textbf{0.384} & \cellcolor{blue!10}\textbf{0.080} & \cellcolor{blue!10}\textbf{0.010} & \cellcolor{blue!10}\textbf{0.008} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}

        & \multirow{5}{*}{\rotatebox{90}{\textbf{Pred.}}}
        ...
        & & KoVAE              & 0.057 & 0.054 & 0.045 & 0.050 & 0.057 & \cellcolor{blue!10}\textbf{0.047} & 0.050 & 0.074 & 0.017 \\
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.053} & \cellcolor{blue!10}\textbf{0.046} & \cellcolor{blue!10}\textbf{0.044} & \cellcolor{blue!10}\textbf{0.044} & \cellcolor{blue!10}\textbf{0.022} & 0.049 & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.069} & \cellcolor{blue!10}\textbf{0.012} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}

        & \multirow{5}{*}{\rotatebox{90}{\textbf{FID}}}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.124} & \cellcolor{blue!10}\textbf{0.035} & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.024} & \cellcolor{blue!10}\textbf{0.170} & \cellcolor{blue!10}\textbf{3.580} & \cellcolor{blue!10}\textbf{0.132} & \cellcolor{blue!10}\textbf{0.015} & \cellcolor{blue!10}\textbf{0.036} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}

        & \multirow{5}{*}{\rotatebox{90}{\textbf{Corr.}}}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.084} & \cellcolor{blue!10}\textbf{0.054} & \cellcolor{blue!10}\textbf{0.065} & \cellcolor{blue!10}\textbf{0.039} & \cellcolor{blue!10}\textbf{0.396} & \cellcolor{blue!10}\textbf{2.031} & \cellcolor{blue!10}\textbf{0.922} & \cellcolor{blue!10}\textbf{0.015} & \cellcolor{blue!10}\textbf{0.019} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \midrule

        %==================================================
        \multirow{20}{*}{\rotatebox{90}{\textbf{Length $= 96$}}}
        & \multirow{5}{*}{\rotatebox{90}{\textbf{Disc.}}}
          & TimeGAN-$\Delta t$ & - & - & - & - & - & - & - & - & - \\
        & & GT-GAN             & - & - & - & - & - & - & - & - & - \\
        & & KoVAE              & 0.284 & 0.103 & 0.276 & 0.089 & 0.341 & - & 0.356 & 0.239 & 0.099 \\
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.070} & \cellcolor{blue!10}\textbf{0.053} & \cellcolor{blue!10}\textbf{0.040} & \cellcolor{blue!10}\textbf{0.030} & \cellcolor{blue!10}\textbf{0.152} & - & \cellcolor{blue!10}\textbf{0.185} & \cellcolor{blue!10}\textbf{0.003} & \cellcolor{blue!10}\textbf{0.017} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.053} & \cellcolor{blue!10}\textbf{0.049} & \cellcolor{blue!10}\textbf{0.045} & \cellcolor{blue!10}\textbf{0.044} & \cellcolor{blue!10}\textbf{0.025} & - & \cellcolor{blue!10}\textbf{0.049} & \cellcolor{blue!10}\textbf{0.155} & \cellcolor{blue!10}\textbf{0.011} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.357} & \cellcolor{blue!10}\textbf{0.508} & \cellcolor{blue!10}\textbf{0.171} & \cellcolor{blue!10}\textbf{0.142} & \cellcolor{blue!10}\textbf{0.394} & - & \cellcolor{blue!10}\textbf{0.309} & \cellcolor{blue!10}\textbf{0.017} & \cellcolor{blue!10}\textbf{0.109} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.114} & \cellcolor{blue!10}\textbf{0.151} & \cellcolor{blue!10}\textbf{0.092} & \cellcolor{blue!10}\textbf{0.094} & \cellcolor{blue!10}\textbf{0.890} & - & \cellcolor{blue!10}\textbf{1.161} & \cellcolor{blue!10}\textbf{0.016} & \cellcolor{blue!10}\textbf{0.014} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \midrule

        %==================================================
        \multirow{20}{*}{\rotatebox{90}{\textbf{Length $= 768$}}}
        & \multirow{5}{*}{\rotatebox{90}{\textbf{Disc.}}}
          & TimeGAN-$\Delta t$ & - & - & - & - & - & - & - & - & - \\
        & & GT-GAN             & - & - & - & - & - & - & - & - & - \\
        & & KoVAE              & 0.238 & 0.201 & 0.236 & 0.196 & 0.428 & - & 0.384 & 0.350 & 0.284 \\
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.088} & \cellcolor{blue!10}\textbf{0.045} & \cellcolor{blue!10}\textbf{0.058} & \cellcolor{blue!10}\textbf{0.052} & \cellcolor{blue!10}\textbf{0.102} & - & \cellcolor{blue!10}\textbf{0.213} & \cellcolor{blue!10}\textbf{0.006} & \cellcolor{blue!10}\textbf{0.022} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.053} & \cellcolor{blue!10}\textbf{0.056} & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.050} & \cellcolor{blue!10}\textbf{0.027} & - & \cellcolor{blue!10}\textbf{0.042} & \cellcolor{blue!10}\textbf{0.204} & \cellcolor{blue!10}\textbf{0.013} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.882} & \cellcolor{blue!10}\textbf{0.439} & \cellcolor{blue!10}\textbf{0.391} & \cellcolor{blue!10}\textbf{0.264} & \cellcolor{blue!10}\textbf{0.318} & - & \cellcolor{blue!10}\textbf{0.796} & \cellcolor{blue!10}\textbf{0.237} & \cellcolor{blue!10}\textbf{0.160} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \cmidrule(lr){2-12}
        ...
        & & ImagenI2R               & \cellcolor{blue!10}\textbf{0.103} & \cellcolor{blue!10}\textbf{0.106} & \cellcolor{blue!10}\textbf{0.122} & \cellcolor{blue!10}\textbf{0.128} & \cellcolor{blue!10}\textbf{0.458} & - & \cellcolor{blue!10}\textbf{1.040} & \cellcolor{blue!10}\textbf{0.006} & \cellcolor{blue!10}\textbf{0.026} \\
        & & Ours               & - & - & - & - & - & - & - & - & - \\
        \bottomrule
    \end{tabular}
    }
...
\begin{table*}[!t]
    \centering
    \caption{Averaged results over 30\%, 50\%, 70\% missing rates under three blocking patterns at length 24, on a 4-dataset subset. Lower values are better. `-' = run not completed for that combination. Bold marks the column-minimum within each (blocking, Disc.) group; Pred.\ excluded by convention.}
    \label{tab:results_blocking}
    \resizebox{\textwidth}{!}{
    \begin{tabular}{ll|cccc|cccc|cccc}
        \toprule
         & & \multicolumn{4}{c|}{\textbf{block\_start}} & \multicolumn{4}{c|}{\textbf{block\_end}} & \multicolumn{4}{c}{\textbf{block\_random}} \\
...
Tab.~\ref{tab:results_combined} details the benchmark results across all three sequence lengths (24, 96, 768). The values represent averages over the $30\%, 50\%$ and $70\%$ missing rates, where the full per-rate results are provided in Tabs.~\ref{tab:irregular_24}, \ref{tab:irregular_96}, and \ref{tab:irregular_768}. In general, our approach presents dramatic improvements across all metrics with respect to the second-best approach (typically KoVAE). Following~\cite{naiman2024generative}, we define the relative improvement error as $e_\text{rel} = (e_2-e_1)/e_2$, where $e_2$ is the second-best error and $e_1$ is ours. In this metric, averaged across all datasets at length 24, our method improves by $\textbf{74.2\%, 15.0\%, 78.5\%, 62.1\%}$ in the discriminative, predictive, context-FID, and correlation scores, respectively. The same table also reports results for the medium (96) and long (768) lengths on all datasets excluding MuJoCo and electricity, where we compare against KoVAE; TimeGAN-$\Delta t$ and GT-GAN are not run at lengths 96/768 (marked `-'). To stress-test robustness beyond random per-step missing, Tab.~\ref{tab:results_blocking} reports averaged results at length 24 under three structured \emph{blocking} patterns (\textsc{block\_start}, \textsc{block\_end}, \textsc{block\_random}), in which a contiguous span of timesteps in each window is removed. ImagenI2R remains the strongest performer across nearly every dataset and metric on this harder regime, while many baselines fail to converge meaningfully (cells marked `-' indicate not-yet-completed runs).
...
\begin{wraptable}{r}{0.37\columnwidth} % Table on the right, 37% of column width
    ...
    \begin{tabular}{c|ccc}
        ...
        ImagenI2R & \cellcolor{blue!10}\textbf{0.155} & \cellcolor{blue!10}\textbf{0.288} & \cellcolor{blue!10}\textbf{0.392} \\
        \bottomrule
    \end{tabular}
    }
    \vspace{-2mm}
\end{wraptable}
At lengths 96 and 768 (rows in Tab.~\ref{tab:results_combined}) we observe the superiority of our method and its advantages to longer horizons, where we achieved mean relative improvement of $\textbf{72.6\%, 29.7\%, 92.1\%, 73.25\%}$ in the discriminative, predictive, context-FID, and correlation scores. See the full results in Tabs.~\ref{tab:irregular_96}, \ref{tab:irregular_768}. Finally, for ultra-long sequences (10{,}920) on the KDD-Cup dataset, our model showed improvements of $\textbf{36.6\%}$ in the discriminative score (see Tab.~\ref{tab:results_ulong}), showing its ability to generate realistic synthetic data even at extreme sequence lengths.
...
\begin{table}[!b]
    ...
    \begin{tabular}{ll|cc|cc|cc|cc}
        ...
        & ImagenI2R  & \cellcolor{blue!10}\textbf{0.061} & \cellcolor{blue!10}\textbf{0.052} & \cellcolor{blue!10}\textbf{0.024} & \cellcolor{blue!10}\textbf{0.034} & \cellcolor{blue!10}\textbf{0.007} & \cellcolor{blue!10}\textbf{0.012} & \cellcolor{blue!10}\textbf{0.065} & \cellcolor{blue!10}\textbf{0.047} \\
        \midrule
    
        \multirow{2}{*}{0.15} & KoVAE & 0.488 & 0.092 & \cellcolor{blue!10}\textbf{0.377} & 0.077 & 0.341 & 0.092 & 0.493 & 0.093 \\
        & ImagenI2R  & \cellcolor{blue!10}\textbf{0.416} & \cellcolor{blue!10}\textbf{0.029} & 0.407 & \cellcolor{blue!10}\textbf{0.059} & \cellcolor{blue!10}\textbf{0.282} & \cellcolor{blue!10}\textbf{0.023} & \cellcolor{blue!10}\textbf{0.467} & \cellcolor{blue!10}\textbf{0.053} \\
        \midrule
    
        \multirow{2}{*}{0.2} & KoVAE & 0.491 & 0.096 & \cellcolor{blue!10}\textbf{0.440} & 0.084 & 0.352 & 0.121 & 0.496 & 0.123 \\
        & ImagenI2R  & \cellcolor{blue!10}\textbf{0.485} & \cellcolor{blue!10}\textbf{0.035} & 0.456 & \cellcolor{blue!10}\textbf{0.062} & \cellcolor{blue!10}\textbf{0.340} & \cellcolor{blue!10}\textbf{0.027} & \cellcolor{blue!10}\textbf{0.457} & \cellcolor{blue!10}\textbf{0.057}  \\
        \bottomrule
    \end{tabular}
    \vspace{-4mm}
    }
...
\renewcommand{\arraystretch}{1}
    ...
    \begin{tabular}{ll|cc|cc|cc}
        ...
        & ImagenI2R (Mask Only) & 0.157 & 0.087 & 0.269 & 0.168 & 0.372 & 0.237 \\
        & ImagenI2R (Without Mask) & 0.158 & 0.025 & 0.307 & 0.045 & 0.444 & 0.013 \\
        & ImagenI2R & \cellcolor{blue!10}\textbf{0.048} & \cellcolor{blue!10}\textbf{0.007} & \cellcolor{blue!10}\textbf{0.065} & \cellcolor{blue!10}\textbf{0.007} & \cellcolor{blue!10}\textbf{0.128} & \cellcolor{blue!10}\textbf{0.007} \\
        \midrule
        ...
        & ImagenI2R (Mask Only) & 0.490 & 0.174 & 0.422 & 0.263 & 0.480 & 0.388 \\
        & ImagenI2R (Without Mask) & 0.402 & 0.033 & 0.476 & 0.072 & 0.491 & 0.082 \\      
        & ImagenI2R & \cellcolor{blue!10}\textbf{0.130} & \cellcolor{blue!10}\textbf{0.011} & \cellcolor{blue!10}\textbf{0.153} & \cellcolor{blue!10}\textbf{0.018} & \cellcolor{blue!10}\textbf{0.272} & \cellcolor{blue!10}\textbf{0.021} \\
        \midrule
        ...
        & ImagenI2R (Mask Only) & 0.437 & 0.249 & 0.349 & 0.450 & 0.435 & 0.491  \\
        & ImagenI2R (Without Mask) & 0.364 & 0.027 & 0.353 & 0.102 & 0.325 & 0.102  \\
        & ImagenI2R & \cellcolor{blue!10}\textbf{0.170} & \cellcolor{blue!10}\textbf{0.025} & \cellcolor{blue!10}\textbf{0.244} & \cellcolor{blue!10}\textbf{0.033} & \cellcolor{blue!10}\textbf{0.251} & \cellcolor{blue!10}\textbf{0.013} \\
        \bottomrule
    \end{tabular}
    }
    \vspace{-6mm}
...
\begin{table}[t]
    ...
    \begin{subtable}[t]{0.57\linewidth}
        ...
        \begin{tabular}{ll|cc|cc|cc}
            ...
            & ImagenI2R DE         & \cellcolor{blue!10}\textbf{0.048} & 0.007 & 0.065 & \cellcolor{blue!10}\textbf{0.007} & \cellcolor{blue!10}\textbf{0.128} & \cellcolor{blue!10}\textbf{0.007} \\
            \midrule
            \multirow{5}{*}{\rotatebox{90}{\textbf{Pred.}}} 
            ...
            & ImagenI2R DE         & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.012} & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.012} & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.011} \\
            \bottomrule
        \end{tabular}
        }
    \end{subtable}
    ...
    \begin{subtable}[t]{0.40\linewidth}
        ...
        \begin{tabular}{l|cc|cc}
            ...
            ImagenI2R (TST)                         & \cellcolor{blue!10}\textbf{0.065} & \cellcolor{blue!10}\textbf{0.007} & \cellcolor{blue!10}\textbf{0.047} & \cellcolor{blue!10}\textbf{0.012} \\
            \bottomrule
        \end{tabular}
        }
    \end{subtable}
...
\begin{table}[!h]
    ...
    \begin{minipage}[t]{0.75\textwidth}
        ...
        \begin{tabular}{ll|cc|cc|cc}
            ...
            & ImagenI2R + Old inverse & 0.023 & 0.018 & 0.040 & 0.037 & 0.067 & 0.048 \\
            & ImagenI2R + New inverse & \cellcolor{blue!10}\textbf{0.020} & \cellcolor{blue!10}\textbf{0.009} & \cellcolor{blue!10}\textbf{0.032} & \cellcolor{blue!10}\textbf{0.005} & \cellcolor{blue!10}\textbf{0.058} & \cellcolor{blue!10}\textbf{0.013} \\
            \midrule
...
\begin{tabular}{ll|c|c|c}
    ...
    & ImagenI2R & \cellcolor{blue!10}\textbf{0.061} & \cellcolor{blue!10}\textbf{0.064} & \cellcolor{blue!10}\textbf{0.087} \\
    \midrule
    ...
    & ImagenI2R & \cellcolor{blue!10}\textbf{0.073} & \cellcolor{blue!10}\textbf{0.091} & \cellcolor{blue!10}\textbf{0.102} \\
...
\resizebox{\linewidth}{!}{
    ...
    \toprule
    \textbf{Dataset} & \textbf{Seq. Len} & \multicolumn{2}{c|}{\textbf{TST (ImagenI2R)}} & \multicolumn{2}{c|}{\textbf{NCDE}} & \multicolumn{2}{c}{\textbf{CSDI}} \\
...
\begin{tabular}{l|cc}
    ...
    \textbf{Joint training with pre-training (ImagenI2R)} & \cellcolor{blue!10}\textbf{0.222} & \cellcolor{blue!10}\textbf{0.024} \\
    \bottomrule
\end{tabular}
}
\end{table}
...
\begin{table}[!t]
    ...
    \begin{tabular}{cc|ccc|ccc|ccc}
        ...
        & ImagenI2R   & $\boldsymbol{1.08}$ & $\boldsymbol{2.85}$ & $\boldsymbol{1.68}$ & $\boldsymbol{1.62}$ & $\boldsymbol{1.84}$ & $\boldsymbol{1.50}$ & $\boldsymbol{1.33}$ & $\boldsymbol{2.39}$ & $\boldsymbol{2.42}$ \\
...
In Table~\ref{tab:combined_time_stacked}, we report the  \emph{net} training time (in hours) for our method (\textbf{ImagenI2R}) and \textbf{KoVAE} until convergence, measured under identical hardware (RTX3090) and batch size settings. Convergence was defined by the best discriminative score achieved during training; specifically, we sampled the generated data every 10 training epochs and computed the discriminative score against the real data. Note that the times shown exclude any overhead for data generation or evaluation; we only measure the pure training runtime until the point of highest discriminative performance.
...
\[
  \bigl(\tfrac{\text{KoVAE time} - \text{ImagenI2R time}}{\text{KoVAE time}} \times 100\%\bigr),
\]
and then averaged these speedups across the three missing rates. Our results show that:
\begin{itemize}
    \item At a sequence length of 24, \textbf{ImagenI2R} converges approximately \(\sim80\%\) faster on average.
    \item At a sequence length of 96, \textbf{ImagenI2R} converges approximately \(\sim87\%\) faster on average.
    \item At a sequence length of 768, \textbf{ImagenI2R} converges approximately \(\sim85\%\) faster on average.
\end{itemize}
...
\begin{tabular}{cc|cccccccccc}
    ...
    \multirow{5}{*}{\textbf{Disc.} $\downarrow$} 
      ...
      & ImagenI2R    
         ...
         & 0.009 \\
    & Ours
       & \textbf{0.009} & \textbf{0.007} & 0.015 & 0.015 & \textbf{0.020} & - & \textbf{0.038} & \textbf{0.012} & \textbf{0.006} & \textbf{0.005} \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Pred.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.040 \\
    & Ours
       & 0.120 & 0.106 & 0.123 & 0.110 & 0.002 & - & 0.251 & 0.095 & 0.037 & 0.032 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Fid.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.028 \\
    & Ours
       & \textbf{0.013} & \textbf{0.010} & \textbf{0.010} & 0.016 & \textbf{0.017} & - & 0.040 & \textbf{0.012} & 0.011 & \textbf{0.018} \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Corr.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & \textbf{0.331} \\
    & Ours
       & \textbf{0.026} & \textbf{0.039} & \textbf{0.020} & \textbf{0.020} & \textbf{0.309} & - & \textbf{0.656} & 0.029 & \textbf{0.005} & 0.333 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Disc.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & \textbf{0.007} \\
    & Ours
       & \textbf{0.011} & 0.007 & 0.019 & 0.016 & \textbf{0.026} & - & \textbf{0.042} & 0.015 & 0.009 & 0.019 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Pred.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.040 \\
    & Ours
       & 0.120 & 0.105 & 0.124 & 0.110 & 0.002 & - & 0.251 & 0.095 & 0.037 & 0.036 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Fid.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & \textbf{0.026} \\
    & Ours
       & \textbf{0.013} & \textbf{0.011} & \textbf{0.023} & \textbf{0.016} & \textbf{0.022} & - & \textbf{0.032} & 0.011 & 0.061 & 0.058 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Corr.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & \textbf{0.342} \\
    & Ours
       & \textbf{0.030} & \textbf{0.039} & \textbf{0.031} & 0.029 & \textbf{0.231} & - & \textbf{0.639} & 0.026 & \textbf{0.010} & 0.375 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Disc.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & \textbf{0.009} \\
    & Ours
       & \textbf{0.026} & \textbf{0.008} & 0.021 & \textbf{0.015} & \textbf{0.030} & - & \textbf{0.073} & - & \textbf{0.007} & 0.011 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Pred.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.041 \\
    & Ours
       & 0.120 & 0.106 & 0.123 & 0.110 & 0.003 & - & 0.252 & - & 0.037 & 0.033 \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Fid.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.044 \\
    & Ours
       & \textbf{0.063} & \textbf{0.017} & \textbf{0.035} & \textbf{0.021} & \textbf{0.025} & - & \textbf{0.052} & - & \textbf{0.019} & \textbf{0.029} \\
    \midrule
    ...
    \multirow{5}{*}{\textbf{Corr.} $\downarrow$}
      ...
      & ImagenI2R
         ...
         & 0.348 \\
    & Ours
       & \textbf{0.046} & \textbf{0.032} & \textbf{0.032} & \textbf{0.032} & \textbf{0.285} & - & \textbf{0.627} & - & \textbf{0.008} & \textbf{0.338} \\
    \bottomrule
\end{tabular}
}
\end{table*}
...
% ---------- Imputation comparison (TST / NeuralCDE / CSDI / Ours) ----------
\begin{table*}[!t]
\centering
\setlength{\tabcolsep}{5pt}
\caption{Imputation results across four datasets at 30\%, 50\%, 70\% missing rates. We compare TST, NeuralCDE, CSDI, and our method using MSE, MAE, and marginal KL divergence (lower is better, best per block in \textbf{bold}). ``--'' denotes pending runs.}
\label{tab:imputation_comparison}
\resizebox{\textwidth}{!}{
\begin{tabular}{cc|ccc|ccc|ccc}
\toprule
 & & \multicolumn{3}{c|}{\textbf{MSE $\downarrow$}} & \multicolumn{3}{c|}{\textbf{MAE $\downarrow$}} & \multicolumn{3}{c}{\textbf{KL $\downarrow$}} \\
\textbf{Dataset} & \textbf{Method} & 30\% & 50\% & 70\% & 30\% & 50\% & 70\% & 30\% & 50\% & 70\% \\
\midrule
\multirow{4}{*}{Stock} & TST & 0.0061 & 0.0047 & 0.0041 & 0.0456 & 0.0371 & 0.0377 & 1.9221 & 1.5573 & 1.5014 \\
 & NCDE & 0.0010 & \textbf{0.0011} & 0.0017 & 0.0186 & \textbf{0.0180} & 0.0192 & 0.1926 & 0.1639 & 0.0822 \\
 & CSDI & 0.0013 & 0.0021 & 0.0025 & 0.0177 & 0.0257 & 0.0285 & 0.0363 & 0.0378 & 0.0641 \\
 & Ours & \textbf{0.0007} & -- & \textbf{0.0013} & \textbf{0.0098} & -- & \textbf{0.0171} & \textbf{0.0054} & \textbf{0.0190} & \textbf{0.0067} \\
\midrule
\multirow{4}{*}{Energy} & TST & 0.0119 & \textbf{0.0099} & \textbf{0.0103} & 0.0505 & \textbf{0.0379} & \textbf{0.0406} & 0.0291 & 0.0203 & 0.0156 \\
 & NCDE & 0.0135 & 0.0145 & -- & 0.0454 & 0.0523 & -- & 0.0866 & 0.0600 & -- \\
 & CSDI & 0.0166 & 0.0141 & -- & 0.0400 & 0.0598 & -- & \textbf{0.0000} & 0.0258 & -- \\
 & Ours & \textbf{0.0117} & 0.0130 & 0.0141 & \textbf{0.0334} & 0.0392 & 0.0468 & 0.0024 & \textbf{0.0074} & \textbf{0.0115} \\
\midrule
\multirow{4}{*}{Weather} & TST & 0.0059 & 0.0064 & 0.0066 & 0.0385 & 0.0358 & 0.0415 & 0.0254 & 0.0241 & 0.0443 \\
 & NCDE & \textbf{0.0026} & \textbf{0.0030} & -- & \textbf{0.0167} & \textbf{0.0172} & -- & 0.0375 & 0.0397 & -- \\
 & CSDI & 0.0035 & -- & -- & 0.0177 & -- & -- & \textbf{0.0009} & -- & -- \\
 & Ours & 0.0039 & 0.0040 & \textbf{0.0051} & 0.0177 & 0.0190 & \textbf{0.0243} & 0.0027 & \textbf{0.0098} & \textbf{0.0012} \\
\midrule
\multirow{4}{*}{ETTh1} & TST & 0.0120 & 0.0125 & 0.0111 & 0.0787 & 0.0799 & 0.0716 & 0.2415 & 0.2995 & 0.2084 \\
 & NCDE & \textbf{0.0026} & \textbf{0.0036} & \textbf{0.0060} & \textbf{0.0332} & \textbf{0.0385} & \textbf{0.0484} & 0.0134 & 0.0172 & 0.0062 \\
 & CSDI & 0.0043 & 0.0044 & 0.0077 & 0.0357 & 0.0442 & 0.0621 & \textbf{0.0001} & \textbf{0.0020} & 0.0117 \\
 & Ours & 0.0029 & 0.0042 & 0.0095 & 0.0338 & 0.0429 & 0.0637 & 0.0010 & 0.0020 & \textbf{0.0028} \\
\bottomrule
\end{tabular}
}
\end{table*}
