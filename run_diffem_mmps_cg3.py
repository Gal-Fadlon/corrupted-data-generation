"""
DiffEM with Unconditional Model + MMPS E-step — CG=3 variant

Same as run_diffem_mmps.py with ONE change:
  Conjugate gradient iterations increased from 1 to 3, providing a better
  posterior denoiser approximation for structured delay-embedding masks.
"""
