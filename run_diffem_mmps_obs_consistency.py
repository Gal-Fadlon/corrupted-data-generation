"""
DiffEM with Unconditional Model + MMPS E-step — Observation Consistency variant

Same as run_diffem_mmps.py with ONE change:
  After E-step imputation, observed positions are overwritten with original
  values to prevent drift caused by delay-embedding img_to_ts averaging.
"""
...
def main(args):
    ...
    name = f"diffem_mmps_obs_consistency_{name}"
