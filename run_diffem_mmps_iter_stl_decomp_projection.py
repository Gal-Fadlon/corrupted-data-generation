"""
DiffEM with MMPS E-step — Iterative-STL Init + Decomposition Consistency Projection

Combines the two strongest orthogonal improvements:
...
def main(args):
    ...
    name = f"diffem_mmps_iter_stl_decomp_projection_{name}"
    logging.info(args)
