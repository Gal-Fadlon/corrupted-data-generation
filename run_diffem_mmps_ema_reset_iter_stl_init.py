"""
DiffEM with Unconditional Model + MMPS E-step — EMA Reset + Iterative STL Warm-Start

Same as run_diffem_mmps_ema_reset.py with ONE change:
  Gaussian initialization is replaced with iterative STL initialization.
  Missing values are filled by iterating: decompose -> impute -> redecompose,
  progressively refining the structural estimates.
"""
...
def main(args):
    ...
    name = f"diffem_mmps_ema_reset_iter_stl_init_{name}"
