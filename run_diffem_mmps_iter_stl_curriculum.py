...
Combines the best initialization (iterative STL) with the curriculum idea:
...
def main(args):
    ...
    name = f"diffem_mmps_iter_stl_curriculum_{name}"
    ...
    with CompositeLogger([WandbLogger()]) if args.wandb else PrintLogger() as logger:
        ...
        print("\n" + "="*60)
        print("DiffEM-MMPS + Iter-STL + Curriculum Training Complete!")
        print("="*60)
        if best_metrics:
        ...
        logging.info("DiffEM-MMPS + Iter-STL + Curriculum training is complete")
