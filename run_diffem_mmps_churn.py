"""
DiffEM with Unconditional Model + MMPS E-step — Stochastic Churn variant

Same as run_diffem_mmps.py with ONE change:
  S_churn=40, S_min=0.05, S_max=50 in MMPSDiffusionProcess to inject
  controlled noise during E-step reverse sampling, encouraging diverse
  imputations and reducing mode collapse.
"""
...
def main(args):
    ...
    name = f"diffem_mmps_churn_{name}"
