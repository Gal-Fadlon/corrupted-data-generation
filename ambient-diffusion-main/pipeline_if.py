...
class IFPipeline(DiffusionPipeline):
    ...
    def prepare_extra_step_kwargs(self, generator, eta):
        ...
        # eta corresponds to η in DDIM diffusion_paper: https://arxiv.org/abs/2010.02502
    ...
    def __call__(
        ...
        Args:
            ...
            eta (`float`, *optional*, defaults to 0.0):
                Corresponds to parameter eta (η) in the DDIM diffusion_paper: https://arxiv.org/abs/2010.02502. Only applies to
        ...
        # of the Imagen diffusion_paper: https://arxiv.org/pdf/2205.11487.pdf . `guidance_scale = 1`
